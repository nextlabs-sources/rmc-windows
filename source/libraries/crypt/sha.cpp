...
Result NX::crypt::CreateSha1(_In_reads_bytes_(data_size) const unsigned char* data,
...
Result NX::crypt::CreateHmacSha1(_In_reads_bytes_(data_size) const unsigned char* data,
    _In_ unsigned long data_size,
...
Result NX::crypt::CreateSha256(_In_reads_bytes_(data_size) const unsigned char* data,
    _In_ unsigned long data_size,
...
Result NX::crypt::CreateHmacSha256(_In_reads_bytes_(data_size) const unsigned char* data,
    _In_ unsigned long data_size,
    _In_reads_bytes_(key_size) const unsigned char* key,
    _In_ unsigned long key_size,
    _Out_writes_bytes_(32) unsigned char* out_buf)
