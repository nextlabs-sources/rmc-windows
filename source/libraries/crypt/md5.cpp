...
Result NX::crypt::CreateMd5(_In_reads_bytes_(data_size) const unsigned char* data,
...
Result NX::crypt::CreateHmacMd5(_In_reads_bytes_(data_size) const unsigned char* data,
    _In_ unsigned long data_size,
