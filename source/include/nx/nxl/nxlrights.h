...
#ifndef __NXL_RIGHTS_DEF_H__
#define __NXL_RIGHTS_DEF_H__
...
#define OBLIGATION_NAME_WATERMARK				L"WATERMARK"
...
__forceinline
unsigned __int64 ActionToRights(const wchar_t* action)
{
	...
	else if (0 == _wcsicmp(RIGHT_ACTION_DOWNLOAD, action)) {
...
__forceinline
const wchar_t* RightToDisplayName(const unsigned __int64 right)
{
...
__forceinline
const wchar_t* ActivityToDisplayName(const unsigned __int64 op)
{
