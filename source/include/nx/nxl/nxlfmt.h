...
#define NXL_FILE_EXTENTIONA ".nxl"
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Details
        ...
        |   0x22C           0x40            Token Protected CEK     0 - 31 Bytes: CEK encrypted by token                                        |
        |                                                           32 - 63 Bytes: CEK Verification Code HMAC_SHA256(CEK, Token)                |
        |   0x26C           0x40            Recovery password       0 - 31 Bytes: CEK encrypted by recovery key                                 |
        |                                   protected CEK           32 - 63 Bytes: CEK Verification Code HMAC_SHA256(CEK, RecoveryKey)          |
        |   0x2AC           0x100           Public Key #1           The public key between member and root                                      |
        |   0x3AC           0x100           Public Key #2           The public key between member and iCA                                       |
        |   0x4AC           0x100           Token Level             Token's maintenance level                                                   |
        |   0x4B0           0x4             Extended Data Offset    The offset of extend key header data                                        |
        |---------------------------------------------------------------------------------------------------------------------------------------|
        |   ### Section Header  ###                                                                                                             |
        |   -> Section table                                                                                                                    |
        |   0x4B4           0x4             Section map             A bits map indicating which sections are valid                              |
        |   0x4B8           0x40            Section Record 0        Section 0, File Internal Attributes (".FileInfo", UTF-8, JSON)              |
        |   0x4F8           0x40            Section Record 1        Section 1, Ad-hoc policy (".AdHoc", UTF-8, JSON)                            |
        |   0x538           0x40            Section Record 2        Section 2, File tags (".FileTag", UTF-8, JSON)                              |
        |   0x578           0x40            Section Record 3        Section 3, user defined                                                     |
        |   0x5B8           0x40            Section Record 4        Section 4, user defined                                                     |
        |   0x5F8           0x40            Section Record 5        Section 5, user defined                                                     |
        |   0x638           0x40            Section Record 6        Section 6, user defined                                                     |
        |   0x678           0x40            Section Record 7        Section 7, user defined                                                     |
        |     .              .                  .                   ...                                                                         |
        |   0xC78           0x40            Section Record 31       Section 31, user defined                                                    |
        |---------------------------------------------------------------------------------------------------------------------------------------|
        |   ### Extended Data  ###                                                                                                              |
        |   0xCB8           0x320           Reserved                Zero                                                                        |
        |---------------------------------------------------------------------------------------------------------------------------------------|
        |   ### Dynamic Header  ###                                                                                                             |
...
typedef struct _NXL_KEYS {
    ...
    unsigned char   token_cek[64];
    unsigned char   recovery_cek[64];
