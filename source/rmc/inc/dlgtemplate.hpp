...
public:
    ...
    virtual void OnOk() {_nResult=IDOK; _bModaless? ::DestroyWindow(_hWnd) : ::EndDialog(_hWnd, IDOK);}
    virtual void OnCancel() {_nResult=IDCANCEL; _bModaless ? ::DestroyWindow(_hWnd) : ::EndDialog(_hWnd, IDCANCEL);}
    ...
    virtual BOOL OnSize(WPARAM wParam, LPARAM lParam) { UNREFERENCED_PARAMETER(wParam); UNREFERENCED_PARAMETER(lParam); return FALSE; }
