...
extern "C" {
	...
	extern 	void send_printing_activity_log(const BOOL allow, const WCHAR *filename, const WCHAR *filepath, const LANGID LangId, const BOOL notify);
	...
	/*[in,out]*/ VARIANT_BOOL * Cancel )
{
	...
	do 
	{
		...
		// take care of rights
		//
		hr = NX::NXL::RAW::CheckRights(DocFullName, &RightsMask, &CustomRightsMask, &EvluationId);
	...
	/*[in,out]*/ VARIANT_BOOL * Cancel )
{
	...
	do 
	{
		...
		{
			send_printing_activity_log(FALSE, DocFullName, DocFullName, GetUserDefaultLangID(), TRUE);
		...
		send_printing_activity_log(TRUE, DocFullName, DocFullName, GetUserDefaultLangID(), FALSE);
	...
	/*[in]*/ Excel::Window * Wn )
{
	...
	do 
	{
		...
		// take care of rights
		//
		hr = NX::NXL::RAW::CheckRights(WbFullName, &RightsMask, &CustomRightsMask, &EvlauationId);
	...
	/*[in,out]*/ VARIANT_BOOL * Cancel )
{
	...
	do 
	{
		...
		// take care of rights
		//
		hr = NX::NXL::RAW::CheckRights(DocFullName, &RightsMask, &CustomRightsMask, &EvaluationId);
	...
	/*[in]*/ Excel2010::Window * Wn )
{
	...
	do 
	{
		...
		// take care of rights
		//
		hr = NX::NXL::RAW::CheckRights(WbFullName, &RightsMask, &CustomRightsMask, &EvaluationId);
