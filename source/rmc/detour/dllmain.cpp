					 ...
					 )
{
	...
	case DLL_PROCESS_ATTACH:
		...
		//	InitializeAdobeCreateProcessHook();
		...
		//	InitializeExplorerCopyFileHook();
		...
		//if (Global.IsGoogleDrvSync) {
		//	InitializeGoogleDrvSyncHook();
		//}
	...
	case DLL_PROCESS_DETACH:
		...
		//CleanupExplorerCopyFileHook();

		//CleanupOutlookDragDropHook();
		//
		//CleanupGoogleDrvSyncHook();
...
//	Global.AcroCreateProcessInitialized = FALSE;
//
...
//
//	if (wcsstr(Global.ProcessName, GOOGLEDRIVE_SYNC_MODULE_NAME)) {
//		Global.IsGoogleDrvSync = TRUE;
//	}
//	else {
//		Global.IsGoogleDrvSync = FALSE;
//	}
//	Global.GoogleDrvSyncHooksInitialized = FALSE;
//}
//
//void CleanupGlobalData(void)
//{
