...
#define ADOBE_MAPISENDMAIL_PROC_NAME		"MAPISendMail"

#define ADOBE_MAPISENDMAILW_PROC_NAME		"MAPISendMailW"

#define ADOBE_CREATEPROCESS_PROC_NAME		"CreateProcessW"
...
typedef HRESULT(WINAPI *ADOBE_MAPISENDMAIL)(
	_In_ LPVOID       lhSession,
	_In_ ULONG_PTR     ulUIParam,
	_In_ LPVOID		lpMessage,
	_In_ unsigned long    flFlags,
	ULONG         ulReserved
	);
...
BOOL WINAPI Core_CreateProcessW(_In_opt_ LPCWSTR lpApplicationName, _Inout_opt_ LPWSTR lpCommandLine, _In_opt_ LPSECURITY_ATTRIBUTES lpProcessAttributes, _In_opt_ LPSECURITY_ATTRIBUTES lpThreadAttributes,
	_In_ BOOL bInheritHandles, _In_ DWORD dwCreationFlags, _In_opt_ LPVOID lpEnvironment, _In_opt_ LPCWSTR lpCurrentDirectory, _In_ LPSTARTUPINFOW lpStartupInfo, _Out_ LPPROCESS_INFORMATION lpProcessInformation);
