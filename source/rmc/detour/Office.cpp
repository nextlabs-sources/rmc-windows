				...
				if (fn_CommandLineToArgvW)
				{
					...
					if (_wcsicmp(Argv[1], L"/p") == 0)
					{
						...
						do 
						{
							...
							// take care of rights
							//
							hr = NX::NXL::RAW::CheckRights(Argv[2], &RightsMask, &CustomRightsMask, &EvaluationId);
	...
	_Outptr_ IStorage** ppstgOpen)
{
	...
	do 
	{
		...
		// take care of rights
		//
		hr = NX::NXL::RAW::CheckRights(pwcsName, &RightsMask, &CustomRightsMask, &EvaluationId);
	...
	)
{
	...
	do 
	{
		...
		// take care of rights
		//
		hr = NX::NXL::RAW::CheckRights(FullPathFileName, &RightsMask, &CustomRightsMask, &EvaluationId);
