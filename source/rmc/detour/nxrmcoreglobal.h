...
#define NXRMCORE_SERVICE_ID_ACTIVITY_LOG			19
...
extern "C" {
	...
	typedef struct _CORE_GLOBAL_DATA{
		...
		void *				pActiveDoc;						//save doc pointer for WinWord;
		...
		BOOL				AcroCreateProcessInitialized;

		ULONG				AcroHFTInitialized;

		#define ADOBEREADER_MODULE_NAME		L"acrord32.exe"	
		#define ADOBEEMAIL_MODULE_NAME_64	L"64BitMAPIBroker.exe"
		#define ADOBEEMAIL_MODULE_NAME_32	L"32BitMAPIBroker.exe"
		...
		//////////////////////////////////////////////////////////////////////////
		//
		// Google drive sync related
		//
		//////////////////////////////////////////////////////////////////////////
		#define GOOGLEDRIVE_SYNC_MODULE_NAME		L"googledrivesync.exe"

		BOOL				IsGoogleDrvSync;

		BOOL				GoogleDrvSyncHooksInitialized;
